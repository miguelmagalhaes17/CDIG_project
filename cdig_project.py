...
class cdig_project(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "cdig_project")
        ...
        self.qtgui_time_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, 0.75, 0, 0, "")
        ...
        self.iio_pluto_source_0.set_frequency(central_freq)
        ...
        self.fir_filter_xxx_0_0 = filter.fir_filter_fff(1, [1/64]*64)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/miguel/Desktop/wifipackets.pcap', False)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_11_decode_mac_1, 'out'), (self.foo_wireshark_connector_0, 'in'))
        self.msg_connect((self.ieee802_11_decode_mac_1, 'out'), (self.ieee802_11_parse_mac_0, 'in'))
        ...
        self.connect((self.ieee802_11_frame_equalizer_0, 0), (self.ieee802_11_decode_mac_1, 0))
    ...
    def set_window_size(self, window_size):
        ...
        self.fir_filter_xxx_0.set_taps([1/self.window_size]*self.window_size)

    def get_sync_length_0(self):
        return self.sync_length_0

    def set_sync_length_0(self, sync_length_0):
        self.sync_length_0 = sync_length_0
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0.set_frequency_range(self.central_freq, self.samp_rate)
...
def main(top_block_cls=cdig_project, options=None):
