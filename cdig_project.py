...
class cdig_project(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ieee802_11_frame_equalizer_0 = ieee802_11.frame_equalizer(ieee802_11.LS, 5.89e9, 10e6, False, False)
        ...
        self.fir_filter_xxx_0 = filter.fir_filter_ccf(1, [1]*window_size)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_11_decode_mac_1, 'out'), (self.blocks_message_debug_0, 'print'))
